...
为了摆脱有争议的不相干的东西,把注意力转向建设性的东西，我们要发明一个虚构的存在。它的大脑是由我们设计的，所以它会按照一组确定的规则来进行推理。这些规则将从简单的,在我们认识是大脑中是必不可少的那部分演绎而来。而这部分是对一个理性的人而言,如果他发现正在违反这些事物时，会愿意改正他们的思路。

原则上，我们可以自由地采纳我们喜欢的任何规则,以及用何种方式来定义我们要研究的机器人。只要你发现它的推理方式于你不同,你就可以把它设计成与你更相像的样子。但是，如果你发现已经非常相似了，并决定你想要,并且相信这个机器人能够帮助你解决推理问题，那么这将是一个理论的成功，而不是一个前提。

我们的机器人已经准备好进行命题推理了。正如之前那样，我们用斜体大写字母{A，B，C等}来表示各种命题，而且我们现在必须要求所使用的任何命题必须对机器人有明确的意义，并且必须是简单的，明确的逻辑上的真或假。也就是说，除非另有说明，否则我们只关心二值逻辑或亚里士多德式逻辑。我们并不要求通过任何额外的调查来确定这些“亚里士多德式命题”是真还是假,事实上正是因为我们并不确定真或假正是我们需要机器人的原因。例如，我个人认为以下两个命题是真的：

A≡贝多芬和柏辽兹从未见过面。
B≡贝多芬的音乐比贝利奥兹的音乐有更好的持续性，尽管柏辽兹的音乐比任何人都不逊色。

目前,命题B对于我们的机器人目前来说不是不可接受的命题，而命题A是可接受的，虽然今天没人知道他们是不是真的从未见过面(注2)。有趣的是,随着我们的理论的展开，看看是否可以放松对A命题的限制，以至于机器人能帮助我们处理像B这样的模糊命题（参见第18章A p分布）(注3)。 
...
注2 从年代上看,他们的会面是可能的，因为他们的有生之年相交了24年;我怀疑的原因是柏辽兹在回忆录中从没有提到这样的见面 - 反过来说，他也从未说过他们没有见面。

注3 我们难以证明机器确实"理解"了一个概念的含义,就像人类理解了命题A一样.人工智能的许多主题都在致力于发明各种奇技淫巧来解决这个问题。但是在第四章会我们会发现这个问题对我们而言几乎是不存在的,合情推理的规则自然而然的对应了数学上的等价性。
...
为了更正式地陈述这些观点，我们引入一些通常的符号逻辑或布尔代数的符号，因为乔治·布尔（GeorgeBoole，1854）引入了类似于以下的符号。当然，演绎逻辑本身的原理在布尔之前几个世纪就已经被很好的理解了，而且我们将会看到，布尔代数的所有结果都被包含在给定的推理规则的特例中
